const styles = {
  ...
  heading:
    "text-[27px] text-center md:text-start font-[600] font-Gilroy pb-[20px]",
  section: "w-11/12 mx-auto",
  productTitle: "text-[25px] font-[600] font-Gilroy text-[#333]",
  productDiscountPrice: "font-bold text-[18px] text-[#333] font-Gilroy",
  ...
  button:
    "w-[150px] font-Gilroy bg-black h-[45px] hover:bg-gray-800 transition-ease-in-out duration-300 my-3 flex fonts-san items-center justify-center rounded-xl cursor-pointer",
  cart_button:
